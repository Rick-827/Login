...
public class frmregistro extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        txtapelido.setBorder(javax.swing.BorderFactory.createTitledBorder("Apelido"));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        String tipousuario=combotipo.getSelectedItem().toString();
         ...
         if(nome.isEmpty()||apelido.isEmpty()||email.isEmpty()||pass.isEmpty()){
             JOptionPane.showMessageDialog(null, "DEVE COMPLETAR TODOS OS CAMPOS ");
         }else{
             if(tipousuario.equalsIgnoreCase("Selecionar")){
                 JOptionPane.showMessageDialog(null, "DEVE SELECIONAR UM TIPO DE CARGO");
             }else{
                 try {
                      String hashedPass = BCrypt.hashpw(pass, BCrypt.gensalt());
                        String consulta = "INSERT INTO usuarios (nome, apelido, email, senha, tipo_nivel) VALUES (?, ?, ?, ?, ?)";
                        ...
                        ps.executeUpdate();
                        limpar();
                        JOptionPane.showMessageDialog(null, "DADOS SALVOS CORRETAMENTE!");
                    } catch (Exception e) {
